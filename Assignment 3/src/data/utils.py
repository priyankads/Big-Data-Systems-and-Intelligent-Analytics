...
# For synrad gen remove 'vis', in list
# Now cast remove vil
...
DEFAULT_DATA_HOME = _thisdir+'/sevir'
print("CURRENT PATH ------ ", _thisdir)
print("DEFAULT_CATALOG ------ ", DEFAULT_CATALOG)
print("DEFAULT_DATA_HOME ------ ", DEFAULT_DATA_HOME)
